					...
					<div class="col-md-12">
						<form class="form-horizontal" @submit.prevent="saveBranch">
							...
							<div class="form-group">
								...
								<label class="col-sm-1 control-label no-padding-right">:</label>
								<div class="col-sm-8">
									<input type="file" ref="branchImage" @change="previewImage">
								</div>
							</div>
							...
							<div class="form-group">
								<div style="width: 100px;height:100px;border: 1px solid #ccc;overflow:hidden;">
									<img id="customerImage" v-if="imageUrl == '' || imageUrl == null" src="/uploads/no_image.jpg">
    ...
    new Vue({
        ...
        methods: {
            ...
            editBranch(branch){
				...
				if(branch.Company_Logo_thum == null || branch.Company_Logo_thum == ''){
					this.imageUrl = null;
				} else {
					this.imageUrl = '/uploads/company_profile_thum/'+ branch.Company_Logo_thum;
				}
            },
            ...
            clearForm(){
				...
				this.selectedFile = null;
				this.imageUrl = '';
				this.$refs.branchImage.value = null;
            }
        }
    })
</script>
