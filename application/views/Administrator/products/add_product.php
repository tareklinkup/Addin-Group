	...
	<form @submit.prevent="saveProduct">
		<div class="row" style="margin-top: 10px;margin-bottom:15px;border-bottom: 1px solid #ccc;padding-bottom: 15px;">
			...
			<div class="col-md-5">
				...
				<div class="form-group clearfix">
					<label class="control-label col-md-4">Self Number:</label>
					<div class="col-md-7">
						<input type="text" class="form-control" v-model="product.Self_Number" required>
					</div>
				</div>
		...
		<div class="col-md-12">
			<div class="table-responsive">
				<datatable :columns="columns" :data="products" :filter-by="filter">
					<template scope="{ row }">
						<tr>
							<td><img :src="'./uploads/products/' + row.Product_Img_Name" alt="" style="width: 60px;height:60px;"></td>
	...
	new Vue({
		...
		methods: {
			...
			editProduct(product) {
				...
				if (product.Product_Img_Name == null || product.Product_Img_Name == '') {
					this.imageUrl = null;
				} else {
					this.imageUrl = '/uploads/products/' + product.Product_Img_Name;
				}
			},
