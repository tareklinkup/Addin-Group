    ...
    new Vue({
        ...
        methods: {
            ...
            addToCart(){
                ...
                if(ind > -1){
                    if((parseFloat(this.cart[ind].quantity) + parseFloat(this.selectedMaterial.quantity)) > this.stock_quantity){
                    ...
                    if(this.selectedMaterial.quantity > this.stock_quantity){
                        this.alert_message = 'Stock unavailable';
                        return;
                    }
