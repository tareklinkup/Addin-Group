					...
					<div class="row">
						...
						<div class="col-sm-2" style="padding-left: 0px;">
							<div class="row" style="margin: 0px;">
								<div style="float: left;">Stock Qty:</div>
								<div style="font-size: 15px;color:#029500;float:right">{{productStock}}</div>
							</div>
							<!-- <p style="font-weight: 600;"><span>Stock Qty: </span><span style="font-size: 15px;color:#029500">{{productStock}}</span></p> -->
							...
							<div class="row" style="margin: 0px;margin:5px 0px">
								<div style="float: left;">Self No:</div>
								<div style="font-size: 15px;color:#029500;float:right">{{selectedProduct.Self_Number}}</div>
							</div>
							<div class="row" style="margin: 0px;text-align:center">
								<div v-if="productPrev">
									<img :src="'../uploads/products/'+ productPrev" alt="" style="width: 60px;height:60px;">

								</div>
								<div v-else>
									<img src="../uploads/no_image.jpg" alt="" style="width: 60px;height:60px;border: 1px solid #ddd;">
						...
						<!-- <div class="col-sm-2">
							<div style="display:none;" v-bind:style="{display:sales.isService == 'true' ? 'none' : ''}">
								...
								<input type="text" id="productStock" v-model="productStock" readonly style="border:none;font-size:20px;padding: 0px;width:100%;text-align:center;color:green">
								<input type="text" id="stockUnit" v-model="selectedProduct.Unit_Name" readonly style="border:none;font-size:12px;width:100%;text-align: center;padding: 0px;"><br>
							</div>
							<input type="password" ref="productPurchaseRate" v-model="selectedProduct.Product_Purchase_Rate" v-on:mousedown="toggleProductPurchaseRate" v-on:mouseup="toggleProductPurchaseRate" readonly title="Purchase rate (click & hold)" style="font-size:12px;width:100%;text-align: center;margin-top: 10px;">

							<div style="width: 100%; text-align: center;margin-top:10px;font-weight: 600;border:1px solid #ccc;">
								<label for="" style="padding: 5px 0px 0 0;margin: 0px;">Self Number</label>
								<input type="test" id="self_number" v-model="selectedProduct.Self_Number" class="form-control" style="text-align: center;border:none;color:green">
							</div>
	...
	new Vue({
		...
		methods: {
			...
			async productOnChange() {
				...
				this.productPrev = this.selectedProduct.Product_Img_Name;
