<style type="text/css">
	...
	.module_title {
		background-color: #00bea97d !important;
		text-align: center;
	...
	.section20 {
		...
		/* background: -webkit-linear-gradient(to right, #b0baef, #ff81d8); */
		/* background: linear-gradient(to right, #b0baef, #ff81d8); */
	}
</style>
...
<?php $branch_id = $this->session->userdata('BRANCHid');
if ($branch_id == 1) { ?>
	<style>
		.section12,
		.section20 {
