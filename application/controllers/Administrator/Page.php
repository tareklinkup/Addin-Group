...
class Page extends CI_Controller {
    ...
    public function getMaterialCategories(){
        $categories = $this->db->query("select * from tbl_materialcategory where status = 'a'")->result();
        echo json_encode($categories);
    }
    ...
    public function addBranch()  {
        ...
        try{
            ...
            if(!empty($_FILES)){
                ...
                if($image != ""){ 
                    $newBranch['Company_Logo_org'] = $images['file_name'];
                    ...
                    $this->load->library('image_lib', $config);
                    $this->image_lib->resize();
                    $newBranch['Company_Logo_thum'] = $this->upload->file_name; 
                }else{
                    $newBranch['Company_Logo_org'] = '';
                    $newBranch['Company_Logo_thum'] = '';
                }
    ...
    public function updateBranch()  {
        ...
        try{
            ...
            $xx = $this->db->query("select * from tbl_brunch where brunch_id = ?", $branch->branchId)->row();
