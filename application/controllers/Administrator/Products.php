...
class Products extends CI_Controller
{
    ...
    public function addProduct()
    {
        ...
        try {
            ...
            if (!empty($_FILES)) {
                ...
                $this->db->query("update tbl_product set Product_Img_Name = ? where Product_SlNo = ?", [$imageName, $pInsertId]);
            }
    ...
    public function updateProduct()
    {
        $res = ['success' => false, 'message' => '', 'productId' => $this->mt->generateProductCode()];
        $productObj = json_decode($this->input->post('data'));
        $result = $this->db->query("select * from tbl_product where Product_SlNo = ?", $productObj->Product_SlNo)->row();
        ...
        try {
            ...
            if (!empty($_FILES)) {
                ...
                // remove image
                if ($result->Product_Img_Name != '' && !empty($_FILES)) {
                    unlink('./uploads/products/' . $result->Product_Img_Name);
                }
                ...
                $this->db->query("update tbl_product set Product_Img_Name = ? where Product_SlNo = ?", [$imageName, $productObj->Product_SlNo]);
            }
